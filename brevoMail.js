import { boni } from "./src/keys/zanned/zanned.js";
...
// ✅ Brevo email sender
export async function sendWithBrevo(to, templateName, variables) {
  ...
  <div class="parent"
    ...
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Thank you for registering
      with <b style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Healing with
        Charlotte Casiraghi</b>. Before we continue, please verify your
      email by entering the 6-digit code we’ve sent to you. <br
        style="margin: 0; padding: 0; box-sizing: border-box;">Protecting your privacy is important to us, and
      verifying your email helps keep your account secure.</p>

    <p class="bottom up"
      style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-top: 10px; margin-bottom: 10px;">Your
      verification code: <strong style="margin: 0; padding: 0; box-sizing: border-box;">{{otpCode}}</strong></p>

    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Why verify?</b></p>
    <ul style="margin: 0; padding: 0; box-sizing: border-box;">
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">It ensures we can send
        you important session updates, personal reflections, and invitations.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">It protects your
        healing journey by confirming the right person is accessing your account.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">It unlocks access to
        book private sessions with Charlotte, where your story will be heard and cherished.</li>
    </ul>
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">If you didn’t create an
      account with us, please ignore this message. For any questions, reach out to
      <b
...
<body
  ...
  <div class="parent"
    ...
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Welcome to <b
        ...
        Casiraghi</b>. I’m honoured that you’ve chosen to embark on this journey
      with me.
      Here, your story will be seen and treasured. Healing with me is not just therapy, it’s a rare and sacred
      connection.</p>
    ...
    <ul style="margin: 0; padding: 0; box-sizing: border-box;">
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          ...
          connection.</b> Whether virtually or in person, we meet soul‑to‑soul.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Personal letters &
          follow‑ups.</b> After each session, I write a private letter just for you and check in
        afterwards.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">An inner circle of
          support.</b> When needed, I introduce you to mentors and friends who can open new doors
        and invite you to intimate gatherings.</li>
    </ul>

    <p class="up"
      style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px; margin-top: 10px;"><b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Next steps:</b></p>
    <ol style="margin: 0; padding: 0; box-sizing: border-box;">
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Book your session:</b>
        Choose between Virtual, In‑Person or Community sessions. Each option includes unique
        bonuses and is tailored to your needs (prices range from <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">€550</b> to <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">€1,600</b>).</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Explore our book:</b>
        <i style="margin: 0; padding: 0; box-sizing: border-box;">Compagnon Féminin</i> is a soul‑companion that speaks
        to every woman you’ve been
        and will
        become. Copies are limited, so consider reserving yours today.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Review our FAQs:</b>
        Learn about payment methods (credit/debit cards or a 16‑digit paysafecard),
        rescheduling (72‑hour notice required) and confidentiality (all sessions are private).</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Stay connected:</b> As
        part of this community, you’ll receive occasional audio messages, reflections and
    ...
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Your healing journey is
      sacred. If you need anything, please reply to this email or write to
      <b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">healingwithcharlottecasiraghi@gmail.com.</b>
    </p>
  ...
  <div class="parent"
    ...
    <ul style="margin: 0; padding: 0; box-sizing: border-box;">
      ...
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
        ...
        your password immediately using <a href="https://guerisonendirectavecharlottecasiraghi.netlify.app/html/regs/forget" target="_blank">our secure link</a> and contact us at
        <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">healingwithcharlottecasiraghi@gmail.com.</b>
      </li>
    </ul>
  ...
  <div class="parent"
    ...
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">This is a confirmation
      that your <b style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Healing with
        Charlotte Casiraghi</b> password was successfully changed. If you
      initiated this change, no further action is necessary. Protecting your privacy and data is important to us, and we
      implement industry‑standard encryption to safeguard your account.</p>
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;"><b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Didn’t change your
        password?</b><br style="margin: 0; padding: 0; box-sizing: border-box;">
      Please reset it immediately using our secure link and notify us at <b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">healingwithcharlottecasiraghi@gmail.com.</b>
    </p>
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Thank you for continuing
      to entrust us with your healing. We’re honoured to walk alongside you.</p>
...
<body
  ...
  <div class="parent"
    ...
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Dear <b
        style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">{{first_name}}</b>,</p>
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Thank you for your
      interest in the <b style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Inner
        Circle Experience</b>. This special program offers a private extended
      session, a signed personal letter, a custom healing plan, soul‑to‑soul guided ritual and curated gifts. Spots are
      limited and currently sold out, so we’ve added you to our waitlist.</p>
    ...
    <ul style="margin: 0; padding: 0; box-sizing: border-box;">
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">You’re now on the
        priority list to be notified as soon as a spot becomes available.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">While you wait, you
        might explore our Virtual, In‑Person and Community sessions (priced from <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">€550</b> to <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">€1,600</b>)
        for immediate healing support.</li>
      <li style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Feel free to read <b
          style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">Compagnon Féminin</b>,
        a soulful companion for women, or browse our FAQs to learn more about
        payment options and rescheduling policies.</li>
    </ul>
    <p style="margin: 0; padding: 0; box-sizing: border-box; width: 100%; margin-bottom: 5px;">We appreciate your
      patience and are honoured by your interest. If you have questions, please reply to this email.
    </p>
    <br style="margin: 0; padding: 0; box-sizing: border-box;">
...
<body
  ...
  const template = templateNames[templateName];
