...
import { collection, getDocs, onSnapshot, query, orderBy, doc, updateDoc } from "https://www.gstatic.com/firebasejs/9.22.1/firebase-firestore.js";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    sendBtn.addEventListener('click', () => {
        ...
        processAdminAction(userId, eventData.id, replyText).then(() => {
            ...
            focusedMessage = null;
            sendBtn.disabled = true; // Disable until a new message is replied to
        });
    });
    ...
    onSnapshot(q, (snapshot) => {
        snapshot.docChanges().forEach((change) => {
            ...
            addUserToList(user, true); // Prepend to show at the top
